...
<body>
    <div class="d-flex" id="content-wrapper">
        ...
        <div id="sidebar-container" class="bg-primary">
            ...
            <div class="menu">
                <a href="#" class="d-block text-light p-3 border-0 active"><b style="font-weight: bold;"><i class="icon ion-md-apps lead mr-2"></i>
                    Tablero</b></a>
                <a href="../forms/frmAsociados.php" class="d-block text-light p-3 border-0 active"><i class="icon ion-ios-people lead mr-2"></i>
                    Asociados</a>
                  ...
                  <div class="container">
                      <div class="row">
                          <div class="col-lg-9 col-md-8">
                            ...
                            <p class="lead text-muted">Revisa la informacion de los asociados</p>
                          </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row mb-2">
                                ...
                                <div class="col-md-4">
                                	<a href="../forms/frmAsociados.php" class="btn btn-primary w-100">MANTENIMIENTO DE ASOCIADOS</a>
                                </div>
                            </div>
                            <div class="row">
                            	<img src="../media/form.png" style="width: 100%;" alt="">
                            </div>
                        </div>
                    </div>
                </div>
